...
* trollocoin.conf: contains configuration settings for trollocoind or trollocoin-qt
* blkindex.dat: block chain index database (BDB)
* blk000?.dat: block data
* database/*: BDB database environment
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by trollocoind or trollocoin-qt
