 ...
 * The Trollocoin Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Trollocoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    setWindowIcon(QIcon(":icons/trollocoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Trollocoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/trollocoin"), tr("&About Trollocoin"), this);
    aboutAction->setToolTip(tr("Show information about Trollocoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Trollocoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/trollocoin"), tr("Show/Hide &Trollocoin"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Trollocoin window"));
    ...
    editConfigAction->setToolTip(tr("Edit the trollocoin.conf file in the default text editor"));
...
#ifndef Q_OS_MAC
            setWindowIcon(QIcon(":icons/trollocoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/trollocoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Trollocoin client"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide Trollocoin"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Trollocoin network", "", count));
}
