...
// for both trollocoind and trollocoin(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Trollocoin releases, the client name should be selected from
