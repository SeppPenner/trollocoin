...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Trollocoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are trollocoin dns seeds.
static const char *strDNSSeed[][2] = {
    {"dnsseed.trollocoin.com", "dnsseed.trollocoin.com"},
    {"dnsseed.trollocoinfoundation.org", "dnsseed.trollocoinfoundation.org"},
    {"dnsseed.xpydev.org", "dnsseed.xpydev.org"},
    {"tseed.trollocoin.com", "tseed.trollocoin.com"},
    {"testnet-seed.trollocoin.mitchellcash.com", "testnet-seed.trollocoin.mitchellcash.com"} // Mitchell Cash
};
...
unsigned int pnSeed[] =
{
    // Hard Code DNS Seed IPS for Trollocoin, trollocoinfoundation, xpydev
...
// trollocoin: stake minter thread
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Trollocoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // trollocoin: mint proof-of-stake blocks in the background
